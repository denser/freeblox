...
*/
	...
	class SBC_General_SettingsModel {
		...
		public static $KEEPALIVE_SIP_METHOD = 'KEEPALIVE_SIP_METHOD';
		public static $KEEPALIVE_INTERVAL = 'KEEPALIVE_INTERVAL';
		public static $KEEPALIVE_FROM_URI = 'KEEPALIVE_FROM_URI';
		public static $USER_AGENT = 'USER_AGENT';
		public static $CDR_MAX_RECORD = 'CDR_MAX_RECORD';
		public static $PING_NAT = 'PING_NAT';
		private static $kep_alive_sip_methods =array("NOTIFY","OPTIONS");

		public function get($name) {
			$dbh = DB_Handle::Connect();
			if ( !isset(self::$get_stmt) ) {
				self::$get_stmt = $dbh->prepare('SELECT VAL FROM SBC_GENERAL_SETTINGS 
							WHERE NAME = :name;');
			}
			self::$get_stmt->reset();
		...
		public function set($name, $val) {
			...
			if ( !isset(self::$set_stmt) ) {
				self::$set_stmt = $dbh->prepare('UPDATE SBC_GENERAL_SETTINGS SET 
		...
		public function keepalive_methods() {
			return SBC_General_SettingsModel::$kep_alive_sip_methods;
		}
	}
?>
