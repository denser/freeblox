...
*/
	...
	if(isset($_POST) && isset($_POST['submit_action'])) {
		if($_POST['submit_action'] == "3") {
			$extension_profiles->deleteExtensionProfilesRule($_POST["EXTENSION_PROFILES"]); // Delete a rule
			$extension_profiles->createActionList(DEPLOY_MODULES::EXTENSION_PROFILES_CONFIG, "Extension Profile rule deleted", DEPLOY_MODULES::EXTENSION_PROFILES_CONFIG_STR, "");
			$delete = 1;
			...
			$extension_profiles->createActionList(DEPLOY_MODULES::EXTENSION_PROFILES_CONFIG, "All Extension Profile rules deleted", DEPLOY_MODULES::EXTENSION_PROFILES_CONFIG_STR, "");
		}
	}
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onclick="javascript: parent.hideMenu();" onload="refreshIframe('<?php print $delete; ?>');">
		<div class="content">
			<h1>Extension Profiles<img src="images/icn_help.png" style="margin-left: 10px; cursor: pointer" onclick="parent.helpPage()" /></h1>
...
<!-- Extension 	Proxy IP 	Proxy Port 		OutBound Profile -->
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><?php echo $row[ExtensionProfilesConfigModel::$INBOUND_SBC_PROFILE]; ?></td>
									<td><?php echo $row[ExtensionProfilesConfigModel::$OUTBOUND_SBC_PROFILE]; ?></td>
									<?php
