...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		if(isset($_POST) && isset($_POST['submit_action'])) {
			if($_POST['enable_remote_login'] == "on")
				...
				$enable = "";
			if( $enable_remote_login != $enable || trim($_POST['log_server']) != $remote_login_server ) {
				$dev_settings->set(DeviceSettingsModel::$ENABLE_REMOTE_LOGGING,$enable);
				$dev_settings->set(DeviceSettingsModel::$REMOTE_LOG_SERVER,trim($_POST['log_server']));
	...
	<body onclick="javascript: parent.hideMenu();" onload="refresh_iframe('<?php print $res;?>');">
		<div class="content">
			<h1>LCR Status<img src="images/icn_help.png" style="margin-left: 10px; cursor: pointer" onclick="parent.helpPage()" /></h1>
