...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		 ...
		 *           boolean:bIncludeHidden - If true then include_once the hidden columns in the calc,
		...
		function _fnFeatureHtmlTable ( oSettings )
		{
			...
			nScrollHead.style.height = "34px"; /* SBC : Modified to reduce the hight of header in sort table */
		...
		function _fnScrollDraw ( o )
		{
			...
			if ( o.oScroll.sX === "" )
			{
				...
				/* I know this is rubbish - but IE7 will make the width of the table when 100% include_once
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input type="text"  class="ipBox" />';
