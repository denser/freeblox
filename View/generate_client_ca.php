	...
	<head>
		...
		<script type="text/javascript">
			...
			function initValidation()
			{
                                ...
                                $sub("#ORGANIZATION_UNIT").attr("data-validation-engine","validate[required,custom[onlyLetterSp],minSize[3],maxSize[32]]");
                                ...
                                $sub("#VALIDITY").attr("data-validation-engine","validate[required,custom[onlyNumber],minSize[1],maxSize[4]],min[30],max[3660]]");
	...
	<body class="popup" onload="refreshIframe('<?php echo $res ?>')">
		<div class="mainborder">
			...
			<div class="popup-content" style="height: 270px">
				<form id="generateuploadServerCA" name="generateuploadServerCA" class="popup-form" action="generate_client_ca.php" target="container" onsubmit="return false" method="POST" autocomplete="off">
				<table class="formtable" cellpadding="2px" cellspacing="2px">
					<tr>
						...
						<tr>
							...
							<td width="20"></td>
							<td>
								<input type="text" class="ipBox" id="ORGANIZATION_UNIT" name="organization_unit" value="" size="" maxlength="16" />
