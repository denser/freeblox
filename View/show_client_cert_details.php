...
*/
	...
	$res = 0;
	if(isset($_GET['data'])) {
		$page_title = "Client Certificate Details";
		$commonName = $_GET['data'];
		$getCertDetails = SysCalls::getClientCertDetails($commonName);
	}
?>
		...
		<div class="mainborder">
			...
			<div class="popup-content" style="height:250px; width:750px;">
				<table class="formtable" cellpadding="2px" cellspacing="2px">
					<!--<tr>
						<td>
							<?php $commonName = explode("=",$showClientCertDetails[1]);
					...
					<tr>
						<td>
							<?php $cn = explode("=",$showClientCertDetails[3]);
					...
					<tr>
						<td>
							<?php $state = explode("=",$showClientCertDetails[2]);
								print "State = ".$state[1];
							?>
						</td>
					</tr>
					<tr>
						<td>
							<?php $orgName = explode("=",$showClientCertDetails[5]);
								print "Organization Name = ".$orgName[1];
							?>
						</td>
					</tr>
						<?php
							$ou_exp =  explode("not",$showClientCertDetails[6]);
					...
					<tr>
						<td>
							<?php $emailId = explode("=",$showClientCertDetails[4]);
					...
					<tr>
						<td>
							<?php $validFrom = explode("=",$ou_exp[1]);
					...
					<tr>
						<td style="padding:3px;">
							<pre><?php print_r($getCertDetails); ?></pre>
						</td>
					</tr>
					</table>
			</div>
