...
*/
	...
	$service_logs = "";
	$service_logs = sysCalls::serviceLogInfo();
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onclick="javascript: parent.hideMenu()">
		<div class="content" style="padding-right:20px;">
			<h1>Service Logs<img src="images/icn_help.png" style="margin-left: 10px; cursor: pointer" onclick="parent.helpPage()" /></h1>
			<table border="0" cellpadding="0" cellspacing="0" style="margin: 0px" class="table-config no-border">
				<tbody>
					<tr>
						<td valign="top">Service Logs :</td>
						<td width="10px">&nbsp;</td>
						<td>
							<textarea cols="80" class="ipTxtArea" readonly="readonly" rows="10"><?php print $service_logs; ?></textarea>
						</td>
					</tr>
				</tbody>
			</table>
